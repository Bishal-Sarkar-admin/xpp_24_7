...
async function fetchAllTableSchemas() {
  ...
  try {
    ...
    const tableNamesResponse = await fetch("https://advance-server-lk2s.onrender.com/api/select", {
      method: "POST",
      headers,
      body: JSON.stringify({
...
async function aiRes(UserRequest, history, databaseSchemas, codeEditorContent) {
  ...
  try {
    const response = await fetch("https://advance-server-lk2s.onrender.com/api/ai", {
      method: "POST",
      headers: {
